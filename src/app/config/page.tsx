...
export default function Config() {
    ...
    return (
        ...
        <main className="w-full h-full flex justify-center pt-[50px]">
            <div className="w-[90dvw] lg:w-[50dvw] bg-gradient-to-t from-cianinho to-rosinha border-4 dark:from-DarkMenuColor dark:to-DarkMenuColor p-[30px] rounded-md flex flex-col items-center">
