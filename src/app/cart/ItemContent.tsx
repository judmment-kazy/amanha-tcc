        ...
        <div className="grid grid-cols-5 text-xs md:text-sm gap-4 border-t-[1.5px] py-4 items-center">
            <div className="col-span-2 justify-start flex gap-2 md:gap-4">
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="w-[70px]"><button className="text-red-500 font-semibold underline" onClick={() => {handleRemoveProductFromCart(item)}}>Remover</button></div>
                </div>
            </div>
            <div className="justify-self-center text-[20px]">{formatPrice(item.price)}</div>
